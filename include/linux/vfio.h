...
#define VFIO_DEVICE_FLAGS_CCW (1 << 4)      /* vfio-ccw device */
  __u32 num_regions; /* Max region index + 1，内存区域的数量 ，BAR
regions（PCI设备） 配置空间 ROM区域 其他设备特定区域*/
  __u32 num_irqs;    /* Max IRQ index + 1，中断的数量 */
};
...
#define VFIO_REGION_INFO_FLAG_CAPS (1 << 3)  /* Info supports caps */
  ...
  __u64 size;       /* Region size (bytes) *///区域的大小
...
enum { VFIO_CCW_IO_IRQ_INDEX, VFIO_CCW_NUM_IRQS };
