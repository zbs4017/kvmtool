...
static void serial8250_generate_fdt_node(void *fdt,
                                         struct device_header *dev_hdr,
                                         fdt_irq_fn irq_fn);
#else
...
static void serial8250_flush_tx(struct kvm *kvm,
...
static void serial8250_update_irq(struct kvm *kvm,
                                  struct serial8250_device *dev) {
  u8 iir = 0;
...
static void serial8250_generate_fdt_node(void *fdt,
  ...
  struct serial8250_device *dev =
      container_of(dev_hdr, struct serial8250_device, dev_hdr);
