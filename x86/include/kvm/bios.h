 ...
 *					start      end
 * Real Mode Interrupt Vector Table	0x00000000 0x000003FF实模式中断向量表
 * BDA area				0x00000400 0x000004FF bios数据区域，用于存储一些系统参数和状态
 * Conventional Low Memory		0x00000500 0x0009FBFF 常规低内存
 * EBDA area				0x0009FC00 0x0009FFFF拓展的bios数据区域
 * VIDEO RAM				0x000A0000 0x000BFFFF 显存区域了
 * VIDEO ROM (BIOS)			0x000C0000 0x000C7FFF
 * ROMs & unus. space (mapped hw & misc)0x000C8000 0x000EFFFF 160 KiB
 *(typically) Motherboard BIOS			0x000F0000 0x000FFFFF Extended
 *Memory			0x00100000 0xFEBFFFFF Reserved (configs, ACPI,
 *PnP, etc)	0xFEC00000 0xFFFFFFFF
 */
