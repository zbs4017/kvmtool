...
static void virtio_mmio_config_in(struct kvm_cpu *vcpu, u64 addr, void *data,
  ...
  case VIRTIO_MMIO_DEVICE_FEATURES:
    if (vmmio->hdr.host_features_sel == 0)
      val = vdev->ops->get_host_features(vmmio->kvm, vmmio->dev);
...
static void virtio_mmio_config_out(struct kvm_cpu *vcpu, u64 addr, void *data,
                                   u32 len, struct virtio_device *vdev) {
  struct virtio_mmio *vmmio = vdev->virtio;
