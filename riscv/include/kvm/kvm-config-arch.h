...
#define OPT_ARCH_RUN(pfx, cfg)                                                 \
  pfx,                                                                         \
      OPT_STRING('\0', "dump-dtb", &(cfg)->dump_dtb_filename, ".dtb file",     \
                 "Dump generated .dtb to specified file"),                     \
      OPT_U64('\0', "custom-mvendorid", &(cfg)->custom_mvendorid,              \
              "Show custom mvendorid to Guest VCPU"),                          \
      OPT_U64('\0', "custom-marchid", &(cfg)->custom_marchid,                  \
              "Show custom marchid to Guest VCPU"),                            \
      OPT_U64('\0', "custom-mimpid", &(cfg)->custom_mimpid,                    \
